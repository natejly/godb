...
func TestIndexExecutor_Lookup_Hash(t *testing.T) {
	th := setupSalesTable(t, storage.NewBufferPool(20, storage.NewDiskStorageManager(t.TempDir())))
...
func TestIndexExecutor_Scan_EdgeCases(t *testing.T) {
	...
	thEmpty := setupSalesTable(t, storage.NewBufferPool(20, storage.NewDiskStorageManager(t.TempDir())))
