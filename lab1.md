# 4371/5371 Lab 1: Storage & Buffer Management
...
In the lab assignments for 4371/5371, you will build a basic disk-based database management system called **GoDB**.
...
this lab, you will focus on the append-only strategy.
...
This lab has an autograded component. Create a zip file containing your `godb` directory.

```bash
zip -r lab1_submission.zip godb/

```
Once the gradescope system is opened, which we will announce later in
the Semester, you will upload this zip file to [Gradescope].
...
* **70%**: Passing public unit tests (Bitmap, HeapPage, BufferPool, TableHeap).
* **30%**: Manual grading of code quality, hidden tests.
